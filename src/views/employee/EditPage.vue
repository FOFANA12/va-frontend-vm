<template>
  <DefaultLayout>
    ...
    >
      <Breadcrumbs :breadcrumbs="breadcrumbs" :pageTitle="t('employee.edit.breadTitle')" />
      ...
      <form @submit.prevent="onSubmit" @keydown="form.onKeydown($event)">
        <div class="flex justify-end mt-4 gap-4">
          ...
          <LinkButton
            v-if="hasPermission(PERMISSIONS.READ_EMPLOYEES)"
            :to="{ name: 'employee-show', params: { id: route.params.id } }"
            variant="primary"
            class="min-w-[100px]"
          >
...
const breadcrumbs = [
  ...
  { title: 'employee.edit.breadActive', disabled: true, to: null },
];
