...
export function getColumns({ t, onEdit, onDelete, onView, onDetails }) {
  return [
    ...
    columnHelper.accessor('name', {
      header: () => t('strategicMap.table.name'),
      cell: (info) => info.getValue(),
    }),
    columnHelper.accessor('structure', {
      header: () => t('strategicMap.table.structure'),
      cell: (info) => info.getValue(),
    }),

    columnHelper.accessor('start_date', {
      header: () => t('strategicMap.table.startDate'),
      cell: (info) => info.getValue(),
    }),
    columnHelper.accessor('end_date', {
      header: () => t('strategicMap.table.endDate'),
      cell: (info) => info.getValue(),
    }),
