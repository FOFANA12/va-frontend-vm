<template>
  <DefaultLayout>
    ...
    >
      <Breadcrumbs :breadcrumbs="breadcrumbs" :pageTitle="t('elementaryLevel.create.breadTitle')" />
...
const breadcrumbs = [
  ...
  { title: 'elementaryLevel.create.breadActive', disabled: true, to: null },
];
...
const onSubmit = async () => {
  try {
    ...
    router.push({ name: 'elementaryLevel' });
  } catch (_error) {}
};
