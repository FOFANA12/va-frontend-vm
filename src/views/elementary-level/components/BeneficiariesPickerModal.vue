<template>
  <CustomModal size="lg" :isModalOpen="isModalOpen" @update:isModalOpen="closeModal">
    <template #title>
      <h2 class="text-md font-semibold">{{ t('elementaryLevel.beneficiaries.modalTitle') }}</h2>
    </template>
            ...
            <thead class="bg-gray-50 text-gray-700">
              <tr>
                ...
                <th class="text-left p-2 border">
                  {{ t('elementaryLevel.beneficiaries.name') }}
                </th>
              </tr>
            </thead>
            <tbody>
    ...
    <template #buttons>
      ...
      >
        {{ t('elementaryLevel.beneficiaries.btnValidate') }}
      </button>
    </template>
  </CustomModal>
</template>
