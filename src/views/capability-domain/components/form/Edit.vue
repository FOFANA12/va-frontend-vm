<template>
        ...
        <div class="grid grid-cols-12 gap-4">
          ...
          <div class="col-span-12 md:col-span-6 lg:col-span-4">
            <SingleSelect
              ...
              :options="store.strategicDomains"
    ...
    <div class="w-full mx-auto bg-white rounded-lg my-6">
      ...
      <div class="card-body p-4">
        ...
        <div class="flex justify-end mt-4">
          ...
          >
            {{ t('capabilityDomain.beneficiaries.addBeneficiary') }}
          </button>
        </div>
      </div>
    </div>
      ...
      <div class="w-full mx-auto bg-white rounded-lg">
        <div class="card-body p-4 flex items-center justify-center">
          <SearchInput
            ...
            :placeholder="t('capabilityDomain.fundingSources.searchPlaceholder')"
                  ...
                  >
                    ...
                    <td class="p-2 border">
                      <input
                        ...
                        :placeholder="t('capabilityDomain.fundingSources.plannedAmount')"
  ...
  <script setup>
import { useCapabilityDomainStore, useSettingsCurrencyStore, useAlertStore } from '@/store';
