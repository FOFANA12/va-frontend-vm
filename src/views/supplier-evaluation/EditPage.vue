...
const backRoute = computed(() => ({
  name: route.name.replace(/-evaluation-(create|edit|show)$/, '-evaluation'),
  params: {
    id: supplierId.value,
  },
}));
...
const {
  ...
  await Promise.all([store.find(route.params.supplierEvaluationId, 'edit')]);
});
