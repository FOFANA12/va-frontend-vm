...
export function getColumns({ t, onEdit, onDelete, onView, onExport, onOptionAction }) {
  return [
    ...
    columnHelper.accessor('abbreviation', {
      header: () => t('structure.table.abbreviation'),
      cell: (info) => info.getValue(),
    }),

    columnHelper.accessor('name', {
      header: () => t('structure.table.name'),
      cell: (info) => info.getValue(),
    }),

    columnHelper.accessor('type', {
      header: () => t('structure.table.type'),
      cell: (info) => info.getValue()?.name,
    }),

    columnHelper.accessor('parent', {
      header: () => t('structure.table.parent'),
      cell: (info) => info.getValue(),
    }),
