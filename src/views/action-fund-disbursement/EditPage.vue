  ...
  <DefaultLayout>
    ...
    >
      <Breadcrumbs
        ...
        :pageTitle="t('actionFundDisbursement.edit.breadTitle')"
      />
      ...
      <form @submit.prevent="onSubmit" @keydown="form.onKeydown($event)">
        <div class="flex justify-end mt-4 gap-4">
          ...
          v-if="hasPermission(PERMISSIONS.READ_FUND_DISBURSEMENTS)"
            :to="{ name: 'action-fund-disbursement-show', params: { id: route.params.id } }"
            variant="primary"
            class="min-w-[100px]"
          >
...
const breadcrumbs = [
  ...
  { title: 'actionFundDisbursement.edit.breadActive', disabled: true, to: null },
];
