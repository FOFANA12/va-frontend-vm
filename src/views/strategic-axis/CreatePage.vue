<template>
  <DefaultLayout>
    ...
    >
      <Breadcrumbs :breadcrumbs="breadcrumbs" :pageTitle="t('strategicAxis.create.breadTitle')" />
...
const breadcrumbs = [
  ...
  { title: 'strategicAxis.create.breadActive', disabled: true, to: null },
];
...
const onSubmit = async () => {
  try {
    ...
    router.push({ name: 'strategic-axes' });
  } catch (_error) {}
};
