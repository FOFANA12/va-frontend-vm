<template>
  <DefaultLayout>
    ...
    >
      <Breadcrumbs :breadcrumbs="breadcrumbs" :pageTitle="t('structureMatrixPeriod.edit.breadTitle')" />
      ...
      <form @submit.prevent="onSubmit" @keydown="form.onKeydown($event)">
        <div class="flex justify-end mt-4 gap-4">
          ...
          <LinkButton
            :to="{ name: 'structure-matrix-period-show', params: { id: route.params.id } }"
            variant="primary"
            class="min-w-[100px]"
          >
...
const breadcrumbs = [
  ...
  { title: 'structureMatrixPeriod.edit.breadActive', disabled: true, to: null },
];
