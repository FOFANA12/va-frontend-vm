<template>
  <DefaultLayout>
    ...
    >
      <Breadcrumbs :breadcrumbs="breadcrumbs" :pageTitle="t('structureMatrixPeriod.create.breadTitle')" />
...
const breadcrumbs = [
  ...
  { title: 'structureMatrixPeriod.create.breadActive', disabled: true, to: null },
];
...
const onSubmit = async () => {
  try {
    ...
    router.push({ name: 'structure-matrix-period' });
  } catch (_error) {}
};
