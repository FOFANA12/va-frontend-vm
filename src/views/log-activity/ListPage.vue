<template>
  <DefaultLayout>
    ...
    >
      <Breadcrumbs :breadcrumbs="breadcrumbs" :pageTitle="t('logActivity.list.breadTitle')" />
      <!-- Action buttons -->
...
const breadcrumbs = [
  ...
  { title: 'sidebar.logActivities', disabled: true },
  { title: 'logActivity.list.breadActive', disabled: true },
];
...
const columns = getColumns({
  t,
  onView: (id) => router.push({ name: 'log-activity-show', params: { id } }),
