        ...
        <div class="grid grid-cols-12 gap-6">
          ...
          <div class="col-span-12">
            <InputReadonly
              ...
              id="name"
              name="name"
              :label="t('settings.indicatorCategory.form.name')"
              :placeholder="t('settings.indicatorCategory.form.namePlaceholder')"
...
import { useSettingsIndicatorCategoryStore } from '@/store';
const store = useSettingsIndicatorCategoryStore();
const { t } = useI18n();
...
const modalTitle = computed(() => {
  switch (context.value) {
    case 'create':
      return t('settings.indicatorCategory.modalTitleCreation');
    case 'edit':
      return t('settings.indicatorCategory.modalTitleModification');
    case 'view':
    default:
      return t('settings.indicatorCategory.modalTitleOverview');
  }
});
