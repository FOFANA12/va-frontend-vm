  ...
  <DefaultLayout>
    ...
    >
      <Breadcrumbs
        ...
        :pageTitle="t('settings.user.breadTitle')"
      />
      <!-- Action buttons -->
      <div class="flex justify-end mt-4 mb-4 gap-4">
        <Button
          v-if="hasPermission(PERMISSIONS.DELETE_USER) && selectedRows.length > 0"
          :icon="Trash"
...
import { useSettingsUserStore } from '@/store';
...
const store = useSettingsUserStore();
