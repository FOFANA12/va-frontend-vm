        ...
        <div class="grid grid-cols-12 gap-6">
          ...
          <div class="col-span-12">
            <InputReadonly
              ...
              id="region"
              name="region"
              :label="t('settings.department.form.region')"
              :placeholder="t('settings.department.form.regionPlaceholder')"
          ...
          <div class="col-span-12">
            <InputReadonly
              ...
              id="name"
              name="name"
              :label="t('settings.department.form.name')"
              :placeholder="t('settings.department.form.namePlaceholder')"
...
import { useSettingsDepartmentStore } from '@/store';
const store = useSettingsDepartmentStore();
const { t } = useI18n();
...
const modalTitle = computed(() => {
  switch (context.value) {
    case 'create':
      return t('settings.department.modalTitleCreation');
    case 'edit':
      return t('settings.department.modalTitleModification');
    case 'view':
    default:
      return t('settings.department.modalTitleOverview');
  }
});
