        ...
        <div class="grid grid-cols-12 gap-6">
          ...
          <div class="col-span-12">
            <InputReadonly
              ...
              id="name"
              name="name"
              :label="t('settings.expenseType.form.name')"
              :placeholder="t('settings.expenseType.form.namePlaceholder')"
...
import { useSettingsExpenseTypeStore } from '@/store';
const store = useSettingsExpenseTypeStore();
const { t } = useI18n();
...
const modalTitle = computed(() => {
  switch (context.value) {
    case 'create':
      return t('settings.expenseType.modalTitleCreation');
    case 'edit':
      return t('settings.expenseType.modalTitleModification');
    case 'view':
    default:
      return t('settings.expenseType.modalTitleOverview');
  }
});
