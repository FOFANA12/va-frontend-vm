...
export function getColumns({ t, onEdit, onDelete, onView }) {
  return [
    ...
    columnHelper.accessor('name', {
      header: () => t('settings.projectOwner.table.name'),
      cell: (info) => info.getValue(),
    }),
    columnHelper.accessor('phone', {
      header: () => t('settings.projectOwner.table.phone'),
      cell: (info) => info.getValue(),
    }),
    columnHelper.accessor('type', {
      header: () => t('settings.projectOwner.table.type'),
      cell: (info) => info.getValue(),
    }),

    columnHelper.accessor('structure', {
      header: () => t('settings.projectOwner.table.structure'),
      cell: (info) => info.getValue(),
    }),
