        ...
        <div class="grid grid-cols-12 gap-6">
          ...
          <div class="col-span-12">
            <InputReadonly
              ...
              id="name"
              name="name"
              :label="t('settings.contractType.form.name')"
              :placeholder="t('settings.contractType.form.namePlaceholder')"
...
import { useSettingsContractTypeStore } from '@/store';
const store = useSettingsContractTypeStore();
const { t } = useI18n();
...
const modalTitle = computed(() => {
  switch (context.value) {
    case 'create':
      return t('settings.contractType.modalTitleCreation');
    case 'edit':
      return t('settings.contractType.modalTitleModification');
    case 'view':
    default:
      return t('settings.contractType.modalTitleOverview');
  }
});
