        ...
        <div class="grid grid-cols-12 gap-6">
          ...
          <div class="col-span-12">
            <InputReadonly
              ...
              id="name"
              name="name"
              :label="t('settings.currency.form.name')"
              :placeholder="t('settings.currency.form.namePlaceholder')"
          ...
          <div class="col-span-12">
            <InputReadonly
              ...
              id="code"
              name="code"
              :label="t('settings.currency.form.code')"
              :placeholder="t('settings.currency.form.codePlaceholder')"
          ...
          <div class="col-span-12 flex items-center">
            ...
            />
            <label for="is_default" class="text-gray-700">
              {{ t('settings.currency.form.isDefault') }}
            </label>
          </div>
...
const store = useSettingsCurrencyStore();
const { t } = useI18n();
...
const modalTitle = computed(() => {
  switch (context.value) {
    case 'create':
      return t('settings.currency.modalTitleCreation');
    case 'edit':
      return t('settings.currency.modalTitleModification');
    case 'view':
    default:
      return t('settings.currency.modalTitleOverview');
  }
});
