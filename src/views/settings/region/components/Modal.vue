        ...
        <div class="grid grid-cols-12 gap-6">
          ...
          <div class="col-span-12">
            <InputReadonly
              ...
              id="name"
              name="name"
              :label="t('settings.region.form.name')"
              :placeholder="t('settings.region.form.namePlaceholder')"
...
import { useSettingsRegionStore } from '@/store';

const store = useSettingsRegionStore();
const { t } = useI18n();
...
const modalTitle = computed(() => {
  switch (context.value) {
    case 'create':
      return t('settings.region.modalTitleCreation');
    case 'edit':
      return t('settings.region.modalTitleModification');
    case 'view':
    default:
      return t('settings.region.modalTitleOverview');
  }
});
