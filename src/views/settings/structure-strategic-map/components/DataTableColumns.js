...
export function getColumns({ t, onEdit, onDelete, onView }) {
  return [
    ...
    columnHelper.accessor('name', {
      header: () => t('settings.structureStrategicMap.table.name'),
      cell: (info) => info.getValue(),
    }),
    columnHelper.accessor('structure', {
      header: () => t('settings.structureStrategicMap.table.structure'),
      cell: (info) => info.getValue(),
    }),

    columnHelper.accessor('start_date', {
      header: () => t('settings.structureStrategicMap.table.startDate'),
      cell: (info) => info.getValue(),
    }),
    columnHelper.accessor('end_date', {
      header: () => t('settings.structureStrategicMap.table.endDate'),
      cell: (info) => info.getValue(),
    }),
