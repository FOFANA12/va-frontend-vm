        ...
        <div class="grid grid-cols-12 gap-6">
          ...
          <div class="col-span-12">
            <InputReadonly
              ...
              id="name"
              name="name"
              :label="t('settings.beneficiary.form.name')"
              :placeholder="t('settings.beneficiary.form.namePlaceholder')"
          ...
          <div class="col-span-12 lg:col-span-6">
            <InputReadonly
              ...
              id="email"
              name="email"
              :label="t('settings.beneficiary.form.email')"
              :placeholder="t('settings.beneficiary.form.emailPlaceholder')"
          ...
          <div class="col-span-12 lg:col-span-6">
            <InputReadonly
              ...
              id="phone"
              name="phone"
              :label="t('settings.beneficiary.form.phone')"
              :placeholder="t('settings.beneficiary.form.phonePlaceholder')"
...
import { useSettingsBeneficiaryStore } from '@/store';
const store = useSettingsBeneficiaryStore();
const { t } = useI18n();
...
const modalTitle = computed(() => {
  switch (context.value) {
    case 'create':
      return t('settings.beneficiary.modalTitleCreation');
    case 'edit':
      return t('settings.beneficiary.modalTitleModification');
    case 'view':
    default:
      return t('settings.beneficiary.modalTitleOverview');
  }
});
...
const openEditModal = async (id) => {
  ...
  try {
    await Promise.all([store.find(id, context.value)]);
    isModalOpen.value = true;
  } catch (err) {
