        ...
        <div class="grid grid-cols-12 gap-6">
          ...
          <div class="col-span-12">
            <InputReadonly
              ...
              id="name"
              name="name"
              :label="t('settings.paymentMode.form.name')"
              :placeholder="t('settings.paymentMode.form.namePlaceholder')"
...
const modalTitle = computed(() => {
  switch (context.value) {
    case 'create':
      return t('settings.paymentMode.modalTitleCreation');
    case 'edit':
      return t('settings.paymentMode.modalTitleModification');
    case 'view':
    default:
      return t('settings.paymentMode.modalTitleOverview');
  }
});
