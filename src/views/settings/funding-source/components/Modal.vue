        ...
        <div class="grid grid-cols-12 gap-6">
          ...
          <div class="col-span-12">
            <InputReadonly
              ...
              id="structure"
              name="structure"
              :label="t('settings.fundingSource.form.structure')"
              :placeholder="t('settings.fundingSource.form.structurePlaceholder')"
          ...
          <div class="col-span-12">
            <InputReadonly
              ...
              id="name"
              name="name"
              :label="t('settings.fundingSource.form.name')"
              :placeholder="t('settings.fundingSource.form.namePlaceholder')"
          ...
          <div class="col-span-12">
            <TextareaReadonly
              ...
              id="description"
              name="description"
              :label="t('settings.fundingSource.form.description')"
              :placeholder="t('settings.fundingSource.form.descriptionPlaceholder')"
...
import { useSettingsFundingSourceStore } from '@/store';
const store = useSettingsFundingSourceStore();
const { t } = useI18n();
...
const modalTitle = computed(() => {
  switch (context.value) {
    case 'create':
      return t('settings.fundingSource.modalTitleCreation');
    case 'edit':
      return t('settings.fundingSource.modalTitleModification');
    case 'view':
    default:
      return t('settings.fundingSource.modalTitleOverview');
  }
});
