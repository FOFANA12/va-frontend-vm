        ...
        <div class="grid grid-cols-12 gap-6">
          ...
          <div class="col-span-12">
            <InputReadonly
              ...
              id="name"
              name="name"
              :label="t('settings.stakeholder.form.name')"
              :placeholder="t('settings.stakeholder.form.namePlaceholder')"
          ...
          <div class="col-span-12 lg:col-span-6">
            <InputReadonly
              ...
              id="email"
              name="email"
              :label="t('settings.stakeholder.form.email')"
              :placeholder="t('settings.stakeholder.form.emailPlaceholder')"
          ...
          <div class="col-span-12 lg:col-span-6">
            <InputReadonly
              ...
              id="phone"
              name="phone"
              :label="t('settings.stakeholder.form.phone')"
              :placeholder="t('settings.stakeholder.form.phonePlaceholder')"
...
import { useSettingsStakeholderStore } from '@/store';

const store = useSettingsStakeholderStore();
const { t } = useI18n();
...
const modalTitle = computed(() => {
  switch (context.value) {
    case 'create':
      return t('settings.stakeholder.modalTitleCreation');
    case 'edit':
      return t('settings.stakeholder.modalTitleModification');
    case 'view':
    default:
      return t('settings.stakeholder.modalTitleOverview');
  }
});
