<template>
  <DefaultLayout>
    ...
    >
      <Breadcrumbs :breadcrumbs="breadcrumbs" :pageTitle="t('settings.role.edit.breadTitle')" />
      ...
      <form @submit.prevent="onSubmit" @keydown="form.onKeydown($event)">
        <div class="flex justify-end mt-4 gap-4">
          ...
          <LinkButton
            :to="{ name: 'settings-role-show', params: { id: route.params.id } }"
            variant="primary"
            class="min-w-[100px]"
          >
...
const breadcrumbs = [
  ...
  { title: 'settings.role.edit.breadActive', disabled: true, to: null },
];
