...
export function getColumns({ t, onEdit, onDelete, onView }) {
  return [
    ...
    columnHelper.accessor('project_owner', {
      header: () => t('settings.delegatedProjectOwner.table.projectOwner'),
      cell: (info) => info.getValue(),
    }),
    columnHelper.accessor('name', {
      header: () => t('settings.delegatedProjectOwner.table.name'),
      cell: (info) => info.getValue(),
    }),

    columnHelper.accessor('phone', {
      header: () => t('settings.delegatedProjectOwner.table.phone'),
      cell: (info) => info.getValue(),
    }),
