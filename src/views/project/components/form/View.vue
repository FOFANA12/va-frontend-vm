<template>
  <div class="card mt-4">
    <div class="w-full mx-auto bg-white rounded-lg">
      <div class="card-header">
        <h2 class="text-xl p-4 pt-2 pb-2">
          {{ t('project.sections.statusDetail') }}
        </h2>
    ...
    <div class="w-full mx-auto bg-white rounded-lg mt-6">
      <div class="card-header">
        <h2 class="text-xl p-4 pt-2 pb-2">
          {{ t('project.sections.stateDetail') }}
        </h2>
        <hr class="border-t border-gray-200 w-full mb-0" />
      </div>
      <div class="card-body p-4">
        ...
        <div class="grid grid-cols-12 gap-4">
          ...
          <div class="col-span-12 md:col-span-6 lg:col-span-4">
            <InputReadonly
              id="reference"
              name="reference"
              :label="t('project.form.reference')"
              :placeholder="t('project.form.referencePlaceholder')"
          ...
          <div class="col-span-12 md:col-span-6 lg:col-span-4">
            <InputReadonly
              ...
              :placeholder="t('project.form.currencyPlaceholder')"
          ...
          <div class="col-span-12 md:col-span-6 lg:col-span-4">
            <InputReadonly
              id="responsible"
              name="responsible"
              :label="t('project.form.responsible')"
              :placeholder="t('project.form.responsiblePlaceholder')"
          ...
          <div class="col-span-12 md:col-span-6 lg:col-span-4">
            <InputReadonly
              ...
              :placeholder="t('project.form.programPlaceholder')"
    ...
    <div class="w-full mx-auto bg-white rounded-lg my-6">
      <div class="card-header">
        <h2 class="text-xl p-4 pt-2 pb-2">
          {{ t('project.sections.beneficiaryInformation') }}
        </h2>
        <hr class="border-t border-gray-200 w-full mb-0" />
      </div>
        ...
        <div class="grid grid-cols-12 gap-4">
          <div class="col-span-12">
            ...
            <div v-else class="text-red-500 text-sm mt-2">
              {{ t('project.beneficiaries.noBeneficiaries') }}
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="w-full mx-auto bg-white rounded-lg my-6">
      <div class="card-header">
        <h2 class="text-xl p-4 pt-2 pb-2">
          {{ t('project.sections.fundingSourcesInformation') }}
        </h2>
        <hr class="border-t border-gray-200 w-full mb-0" />
      </div>
            ...
            <thead class="bg-gray-50 text-gray-700 text-sm">
              <tr>
                <th class="p-2 border text-left w-[50%]">
                  {{ t('project.fundingSources.name') }}
                </th>
                <th class="p-2 border text-left w-[20%]">
                  {{ t('project.fundingSources.plannedAmount') }}
                </th>
              </tr>
            </thead>
            <tbody>
              <tr v-if="!form.funding_sources?.length">
                <td colspan="3" class="text-center text-red-500 py-4 border">
                  {{ t('project.fundingSources.noFundingSources') }}
                </td>
              </tr>
              <tr
              ...
              >
                <td class="p-2 border text-right">
                  {{ t('project.fundingSources.plannedBudget') }}
                </td>
                <td class="p-2 border">
    ...
    <div class="w-full mx-auto bg-white rounded-lg my-6">
      <div class="card-header">
        <h2 class="text-xl p-4 pt-2 pb-2">
          {{ t('project.sections.descriptiveCharacteristics') }}
        </h2>
        <hr class="border-t border-gray-200 w-full mb-0" />
      </div>
      <div class="card-body p-4">
        <div class="flex flex-col gap-6">
          ...
          <div class="col-span-12">
            <TextareaReadonly
              ...
              :label="t('project.form.prerequisites')"
              :placeholder="t('project.form.prerequisitesPlaceholder')"
          ...
          <div class="col-span-12">
            <TextareaReadonly
              ...
              :label="t('project.form.impacts')"
              :placeholder="t('project.form.impactsPlaceholder')"
          ...
          <div class="col-span-12">
            <TextareaReadonly
              ...
              name="risks"
              v-model="form.risks"
              :label="t('project.form.risks')"
              :placeholder="t('project.form.risksPlaceholder')"
...
<script setup>
import { useProjectStore, useSettingsCurrencyStore } from '@/store';
