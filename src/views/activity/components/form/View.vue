        ...
        <div class="grid grid-cols-12 gap-4">
          ...
          <div class="col-span-12 md:col-span-6 lg:col-span-4">
            <InputReadonly
              id="startDate"
              name="startDate"
              :label="t('activity.form.startDate')"
              :placeholder="t('activity.form.startDatePlaceholder')"
          ...
          <div class="col-span-12 md:col-span-6 lg:col-span-4">
            <InputReadonly
              id="endDate"
              name="endDate"
              :label="t('activity.form.endDate')"
              :placeholder="t('activity.form.endDatePlaceholder')"
...
<script setup>
import { useActivityStore, useSettingsCurrencyStore } from '@/store';
