<template>
  <div class="card mt-4">
    <div class="w-full mx-auto bg-white rounded-lg" v-if="context !== 'create'">
      <div class="card-header">
        <h2 class="text-xl p-4 pt-2 pb-2">
          {{ t('activity.sections.statusDetail') }}
        </h2>
    ...
    <div class="w-full mx-auto bg-white rounded-lg mt-6" v-if="context !== 'create'">
      <div class="card-header">
        <h2 class="text-xl p-4 pt-2 pb-2">
          {{ t('activity.sections.stateDetail') }}
        </h2>
        <hr class="border-t border-gray-200 w-full mb-0" />
      </div>
      <div class="card-body p-4">
        ...
        <div class="grid grid-cols-12 gap-4">
          ...
          <div v-if="form.reference" class="col-span-12 md:col-span-6 lg:col-span-4">
            <InputReadonly
              id="reference"
              name="reference"
              :label="t('activity.form.reference')"
              :placeholder="t('activity.form.referencePlaceholder')"
          ...
          <div class="col-span-12 md:col-span-6 lg:col-span-4">
            <DatePicker
              ...
              :placeholder="t('project.form.endDatePlaceholder')"
          ...
          <div class="col-span-12 md:col-span-6 lg:col-span-4">
            <InputReadonly
              id="currency"
              name="currency"
              :label="t('activity.form.currency')"
              :placeholder="t('activity.form.currencyPlaceholder')"
          ...
          <div class="col-span-12 md:col-span-6 lg:col-span-4">
            <SingleSelect
              ...
              :label="t('activity.form.responsible')"
              :options="store.responsibles"
              :placeholder="t('activity.form.responsiblePlaceholder')"
          ...
          <div class="col-span-12 md:col-span-6 lg:col-span-4">
            <SingleSelect
              ...
              :label="t('activity.form.project')"
              :options="store.projects"
              :placeholder="t('activity.form.projectPlaceholder')"
    ...
    <div class="w-full mx-auto bg-white rounded-lg my-6">
      <div class="card-header">
        <h2 class="text-xl p-4 pt-2 pb-2">
          {{ t('activity.sections.beneficiaryInformation') }}
        </h2>
        <hr class="border-t border-gray-200 w-full mb-0" />
      </div>
      ...
      <div class="card-body p-4">
        <div class="grid grid-cols-12 gap-4">
          <div class="col-span-12">
            ...
            <div v-else class="text-red-500 text-sm mt-2">
              {{ t('activity.beneficiaries.noBeneficiaries') }}
            </div>
          </div>
        </div>
        ...
        <div class="flex justify-end mt-4">
          ...
          >
            {{ t('activity.beneficiaries.addBeneficiary') }}
          </button>
        </div>
      </div>
    </div>
    ...
    <div class="w-full mx-auto bg-white rounded-lg my-6">
      <div class="card-header">
        <h2 class="text-xl p-4 pt-2 pb-2">
          {{ t('activity.sections.fundingSourcesInformation') }}
        </h2>
        <hr class="border-t border-gray-200 w-full mb-0" />
      </div>
      ...
      <div class="w-full mx-auto bg-white rounded-lg">
        <div class="card-body p-4 flex items-center justify-center">
          <SearchInput
            ...
            :placeholder="t('activity.fundingSources.searchPlaceholder')"
                ...
                <thead class="bg-gray-50 text-gray-700 text-sm">
                  <tr>
                    <th class="p-2 border text-left w-[50%]">
                      {{ t('activity.fundingSources.name') }}
                    </th>
                    <th class="p-2 border text-left w-[20%]">
                      {{ t('activity.fundingSources.plannedAmount') }}
                    </th>
                ...
                <tbody>
                  <tr v-if="!form.funding_sources?.length">
                    <td colspan="3" class="text-center text-red-500 py-4 border">
                      {{ t('activity.fundingSources.noFundingSources') }}
                    </td>
                  </tr>
                  <tr
                  ...
                  >
                    ...
                    <td class="p-2 border">
                      <input
                        ...
                        :placeholder="t('activity.fundingSources.plannedAmount')"
                  ...
                  >
                    <td class="p-2 border text-right">
                      {{ t('activity.fundingSources.plannedBudget') }}
                    </td>
                    <td class="p-2 border">
    ...
    <div class="w-full mx-auto bg-white rounded-lg my-6">
      <div class="card-header">
        <h2 class="text-xl p-4 pt-2 pb-2">
          {{ t('activity.sections.descriptiveCharacteristics') }}
        </h2>
        <hr class="border-t border-gray-200 w-full mb-0" />
      </div>
      <div class="card-body p-4">
        <div class="flex flex-col gap-6">
          ...
          <div class="col-span-12">
            <Textarea
              ...
              :label="t('activity.form.prerequisites')"
              :placeholder="t('activity.form.prerequisitesPlaceholder')"
          ...
          <div class="col-span-12">
            <Textarea
              ...
              :label="t('activity.form.impacts')"
              :placeholder="t('activity.form.impactsPlaceholder')"
          ...
          <div class="col-span-12">
            <Textarea
              ...
              name="risks"
              v-model="form.risks"
              :label="t('activity.form.risks')"
              :placeholder="t('activity.form.risksPlaceholder')"
  ...
  <script setup>
import { useActivityStore, useSettingsCurrencyStore, useAlertStore } from '@/store';
