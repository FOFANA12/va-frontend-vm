<template>
  <form @submit.prevent="onSubmit" @keydown="form.onKeydown($event)">
    <div class="flex justify-end mt-4 gap-4">
      ...
      <LinkButton
        v-if="hasPermission(PERMISSIONS.READ_STRATEGIC_DOMAINS)"
        :to="{ name: 'strategicDomain-show', params: { id: route.params.id } }"
        variant="primary"
        class="min-w-[100px]"
      >
...
import { useStrategicDomainStore, useAlertStore } from '@/store';
