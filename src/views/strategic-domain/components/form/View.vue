<template>
  <div class="card mt-4">
    <div class="w-full mx-auto bg-white rounded-lg">
      <div class="card-header">
        <h2 class="text-xl p-4 pt-2 pb-2">
          {{ t('strategicDomain.sections.statusDetail') }}
        </h2>
    ...
    <div class="w-full mx-auto bg-white rounded-lg mt-6">
      <div class="card-header">
        <h2 class="text-xl p-4 pt-2 pb-2">
          {{ t('strategicDomain.sections.stateDetail') }}
        </h2>
        <hr class="border-t border-gray-200 w-full mb-0" />
      </div>
      <div class="card-body p-4">
        ...
        <div class="grid grid-cols-12 gap-4">
          ...
          <div class="col-span-12 md:col-span-6 lg:col-span-4">
            <InputReadonly
              id="reference"
              name="reference"
              :label="t('strategicDomain.form.reference')"
              :placeholder="t('strategicDomain.form.referencePlaceholder')"
          ...
          <div class="col-span-12 md:col-span-6 lg:col-span-4">
            <InputReadonly
              id="name"
              name="name"
              :label="t('strategicDomain.form.name')"
              :placeholder="t('strategicDomain.form.namePlaceholder')"
          ...
          <div class="col-span-12 md:col-span-6 lg:col-span-4">
            <InputReadonly
              id="startDate"
              name="startDate"
              :label="t('strategicDomain.form.startDate')"
              :placeholder="t('strategicDomain.form.startDatePlaceholder')"
          ...
          <div class="col-span-12 md:col-span-6 lg:col-span-4">
            <InputReadonly
              id="endDate"
              name="endDate"
              :label="t('strategicDomain.form.endDate')"
              :placeholder="t('strategicDomain.form.endDatePlaceholder')"
          ...
          <div class="col-span-12 md:col-span-6 lg:col-span-4">
            <InputReadonly
              id="currency"
              name="currency"
              :label="t('strategicDomain.form.currency')"
              :placeholder="t('strategicDomain.form.currencyPlaceholder')"
          ...
          <div class="col-span-12 md:col-span-6 lg:col-span-4">
            <InputReadonly
              id="responsible"
              name="responsible"
              :label="t('strategicDomain.form.responsible')"
              :placeholder="t('strategicDomain.form.responsiblePlaceholder')"
          ...
          <div class="col-span-12 md:col-span-6 lg:col-span-4">
            <InputReadonly
              id="action_domain"
              name="action_domain"
              :label="t('strategicDomain.form.actionDomain')"
              :placeholder="t('strategicDomain.form.actionDomainPlaceholder')"
    ...
    <div class="w-full mx-auto bg-white rounded-lg my-6">
      <div class="card-header">
        <h2 class="text-xl p-4 pt-2 pb-2">
          {{ t('strategicDomain.sections.beneficiaryInformation') }}
        </h2>
        <hr class="border-t border-gray-200 w-full mb-0" />
      </div>
        ...
        <div class="grid grid-cols-12 gap-4">
          <div class="col-span-12">
            ...
            <div v-else class="text-red-500 text-sm mt-2">
              {{ t('strategicDomain.beneficiaries.noBeneficiaries') }}
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="w-full mx-auto bg-white rounded-lg my-6">
      <div class="card-header">
        <h2 class="text-xl p-4 pt-2 pb-2">
          {{ t('strategicDomain.sections.fundingSourcesInformation') }}
        </h2>
        <hr class="border-t border-gray-200 w-full mb-0" />
      </div>
            ...
            <thead class="bg-gray-50 text-gray-700 text-sm">
              <tr>
                <th class="p-2 border text-left w-[50%]">
                  {{ t('strategicDomain.fundingSources.name') }}
                </th>
                <th class="p-2 border text-left w-[20%]">
                  {{ t('strategicDomain.fundingSources.plannedAmount') }}
                </th>
              </tr>
            </thead>
            <tbody>
              <tr v-if="!form.funding_sources?.length">
                <td colspan="3" class="text-center text-red-500 py-4 border">
                  {{ t('strategicDomain.fundingSources.noFundingSources') }}
                </td>
              </tr>
              <tr
              ...
              >
                <td class="p-2 border text-right">
                  {{ t('strategicDomain.fundingSources.plannedBudget') }}
                </td>
                <td class="p-2 border">
    ...
    <div class="w-full mx-auto bg-white rounded-lg my-6">
      <div class="card-header">
        <h2 class="text-xl p-4 pt-2 pb-2">
          {{ t('strategicDomain.sections.descriptiveCharacteristics') }}
        </h2>
        <hr class="border-t border-gray-200 w-full mb-0" />
      </div>
      <div class="card-body p-4">
        <div class="flex flex-col gap-6">
          ...
          <div class="col-span-12">
            <TextareaReadonly
              ...
              :label="t('strategicDomain.form.description')"
              :placeholder="t('strategicDomain.form.descriptionPlaceholder')"
          ...
          <div class="col-span-12">
            <TextareaReadonly
              ...
              :label="t('strategicDomain.form.prerequisites')"
              :placeholder="t('strategicDomain.form.prerequisitesPlaceholder')"
          ...
          <div class="col-span-12">
            <TextareaReadonly
              ...
              :label="t('strategicDomain.form.impacts')"
              :placeholder="t('strategicDomain.form.impactsPlaceholder')"
          ...
          <div class="col-span-12">
            <TextareaReadonly
              ...
              name="risks"
              v-model="form.risks"
              :label="t('strategicDomain.form.risks')"
              :placeholder="t('strategicDomain.form.risksPlaceholder')"
...
<script setup>
import { useStrategicDomainStore, useSettingsCurrencyStore } from '@/store';
